  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="bg-white rounded-2xl p-5 shadow-sm border border-slate-100 card-hover flex items-center gap-4">
        ...
        <div>
          <p class="text-2xl font-bold text-slate-800 leading-none">{{ list.filter(u => isAdmin(u)).length }}</p>
          ...
          <el-table-column label="操作" width="180" align="center" fixed="right">
            <template #default="{ row }">
              <div class="flex items-center justify-center gap-3">
                ...
                <el-button type="warning" @click="openRoleDialog(row)">角色</el-button>
...
function isAdmin(user) {
  ...
  return roles.some(r => {
    ...
    return r?.code === 'admin' || r?.roleCode === 'admin'
  })
}
