...
('P009', '主轴轴杆', NULL, 'D40x200mm Alloy Steel', 'pcs', 210.00, 1),
('P010', '连杆', NULL, 'D30x150mm Forged Steel', 'pcs', 95.00, 1),
('P011', '活塞环组', NULL, 'D80mm Chrome Plated', 'set', 35.00, 1),
('P012', '油封 DN50', NULL, 'DN50xDN65x10mm NBR', 'pcs', 12.00, 1),
('P013', '止推垫圈', NULL, 'D60xD40x3mm Bronze', 'pcs', 8.00, 1),
('P014', '挡圈', NULL, 'D45mm Spring Steel', 'pcs', 3.50, 1),
('P015', '同步带轮', NULL, '5M-32T Aluminum', 'pcs', 42.00, 1),
('P016', '直线导轨', NULL, 'HGR20x1000mm', 'pcs', 380.00, 1),
('P017', '滚珠丝杠总成', NULL, 'SFU1605x800mm', 'set', 560.00, 1),
('P018', '联轴器 DJ40', NULL, 'D40x60mm Aluminum', 'pcs', 28.00, 1),
('P019', '限位开关支架', NULL, '45x30x15mm SS304', 'pcs', 15.00, 1),
('P020', '拖链', NULL, '25x38mm Nylon PA66', 'm', 22.00, 1),
('P021', '液压缸密封圈', NULL, 'D63xD50x8mm PU', 'pcs', 18.00, 1),
('P022', '阀芯', NULL, 'D12x45mm Hardened Steel', 'pcs', 55.00, 1),
('P023', '弹簧垫圈 M10', NULL, 'M10 Spring Steel 65Mn', 'pcs', 0.80, 1),
('P024', '六角螺栓 M12x60', NULL, 'M12x60mm Grade 8.8', 'pcs', 2.50, 1),
('P025', '滚针轴承 NK25', NULL, 'NK25/20 Precision', 'pcs', 18.00, 1),
('P026', 'O型圈套装', NULL, '30pcs NBR Mixed Size', 'set', 25.00, 1),
('P027', '滚齿毛坯', NULL, 'D80x30mm 20CrMnTi', 'pcs', 48.00, 1),
('P028', '花键轴', NULL, 'D25x200mm 40Cr', 'pcs', 75.00, 1),
('P029', '端板', NULL, '120x80x10mm Q235', 'pcs', 22.00, 1),
('P030', '安装底座', NULL, '200x150x30mm HT200', 'pcs', 85.00, 1);
